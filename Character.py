...
class Character(BaseTab):
    ...
    def update_table(self):
        ...
        for column in Character.COLUMNS:
        ...
        self.table_model.setSortOrder(columnName=Character.COLUMNS[3], reverse=1)
        self.table_model.setSortOrder(columnName=Character.COLUMNS[2])
