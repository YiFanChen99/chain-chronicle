...
class CharacterPowerWindow(BasicWindow):
    ...
    def submitting(self):
        ...
        self.character_power.atk = self.atk.get()
        self.character_power.level = self.level.get()
        self.character_power.atk_raised = self.atk_raised.get()
        self.character_power.hit_rate = self.hit_rate.get()
        self.character_power.critical_ratio = self.critical_ratio.get()
        self.character_power.critical_factor = self.critical_factor.get()
        self.character_power.active_factor = self.active_factor.get()
        self.character_power.active_cost = self.active_cost.get()
